    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="row">
                    <div class="col-lg-6">
                        <form action="/topshiriq/store" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleTextarea">Topshiriq haqida</label>
                                <textarea class="form-control" id="exampleTextarea" rows="3" name="izoh"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="dedline" name="dedline" type="datetime-local" placeholder="Tugash vaqti">
                            </div>
