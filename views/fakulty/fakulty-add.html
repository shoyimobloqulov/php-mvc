    ...
    <ul class="app-menu">
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-home"></i><span class="app-menu__label">Fakultet</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item active" href="/fakulty-add.html"><i class="icon fa fa-plus"></i> Qo'shish</a></li>
            </ul>
        </li>
                    ...
                    <div class="col-lg-6">
                        <form>
                            <div class="form-group">
                                ...
                                <input class="form-control" id="" type="text" aria-describedby="emailHelp" placeholder="Name email"><small class="form-text text-muted" id="emailHelp">We'll never share your email with anyone else.</small>
                            </div>
                        </form>
                    </div>
                </div>
