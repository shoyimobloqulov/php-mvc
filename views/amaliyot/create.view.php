...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Amaliyot qo'shish </h1>
            <p>Tizimga Amaliyot qo'shish</p>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="row">
                    <div class="col-lg-6">
                        <form action="/amaliyot/store" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="" name="direktor" type="text" aria-describedby="emailHelp" placeholder="Direktor ">
                            </div>

                            <div class="form-group">
                                <label for="">Telefon</label>
                                <input class="form-control" id="call" name="telefon" type="text" aria-describedby="emailHelp" placeholder="Telefon ">
                            </div>

                            <div class="form-group">
                                <label for="">Manzil</label>
                                <input class="form-control" id="manzil" name="manzil" type="text" aria-describedby="emailHelp" placeholder="Manzil ">

                            </div>

                            <div class="form-group">
                                <label for="">Manzil linki</label>
                                <input class="form-control" id="link" name="link" type="text" aria-describedby="emailHelp" placeholder="Link ">
                            </div>
