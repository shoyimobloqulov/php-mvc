    ...
    <ul class="app-menu">
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-home"></i><span class="app-menu__label">Fakultet</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="fakulty/fakulty-eye.html"><i class="icon fa fa-eye"></i> Ko'rish</a></li>
                <li><a class="treeview-item" href="fakulty/fakulty-add.html"><i class="icon fa fa-plus"></i> Qo'shish</a></li>
            </ul>
        </li>
